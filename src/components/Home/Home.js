...
const Home = () => {
    ...
    return (
        <div>
            <section className='grid grid-cols-[3fr,2fr] gap-10 px-24 '>
                <div className="hero-section-left h-[90vh] flex flex-col justify-center">
                ...
                <div className="banner-image h-[90vh] flex flex-col justify-center ">
                    <img src={banner} alt="" />
                </div>
            </section>
            <section>
                <div className='title text-center capitalize text-2xl font-bold mt-6'>customer reviews (3)</div>
